define(["core/config", "core/token", "login", "core/uk", "header", "./toolbar", "./wizard/wizard", "./confirm", "./process", "./widget/widget"], function (conf, token, login, uk, header, toolbar, wizard, confirm, process, widget) {
